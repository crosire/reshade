...
static void load_procs(void)
{
	...
	if (!gl3wBlendColor) gl3wBlendColor = (PFNGLBLENDCOLORPROC) get_proc("glBlendColorEXT");
	gl3wBlendEquation = (PFNGLBLENDEQUATIONPROC) get_proc("glBlendEquation");
	if (!gl3wBlendEquation) gl3wBlendEquation = (PFNGLBLENDEQUATIONPROC) get_proc("glBlendEquationEXT");
	gl3wDrawRangeElements = (PFNGLDRAWRANGEELEMENTSPROC) get_proc("glDrawRangeElements");
	if (!gl3wDrawRangeElements) gl3wDrawRangeElements = (PFNGLDRAWRANGEELEMENTSPROC) get_proc("glDrawRangeElementsEXT");
	gl3wTexImage3D = (PFNGLTEXIMAGE3DPROC) get_proc("glTexImage3D");
	if (!gl3wTexImage3D) gl3wTexImage3D = (PFNGLTEXIMAGE3DPROC) get_proc("glTexImage3DEXT");
	gl3wTexSubImage3D = (PFNGLTEXSUBIMAGE3DPROC) get_proc("glTexSubImage3D");
	if (!gl3wTexSubImage3D) gl3wTexSubImage3D = (PFNGLTEXSUBIMAGE3DPROC) get_proc("glTexSubImage3DEXT");
	gl3wCopyTexSubImage3D = (PFNGLCOPYTEXSUBIMAGE3DPROC) get_proc("glCopyTexSubImage3D");
	if (!gl3wCopyTexSubImage3D) gl3wCopyTexSubImage3D = (PFNGLCOPYTEXSUBIMAGE3DPROC) get_proc("glCopyTexSubImage3DEXT");
	gl3wActiveTexture = (PFNGLACTIVETEXTUREPROC) get_proc("glActiveTexture");
	if (!gl3wActiveTexture) gl3wActiveTexture = (PFNGLACTIVETEXTUREPROC) get_proc("glActiveTextureARB");
	gl3wSampleCoverage = (PFNGLSAMPLECOVERAGEPROC) get_proc("glSampleCoverage");
	if (!gl3wSampleCoverage) gl3wSampleCoverage = (PFNGLSAMPLECOVERAGEPROC) get_proc("glSampleCoverageARB");
	gl3wCompressedTexImage3D = (PFNGLCOMPRESSEDTEXIMAGE3DPROC) get_proc("glCompressedTexImage3D");
	if (!gl3wCompressedTexImage3D) gl3wCompressedTexImage3D = (PFNGLCOMPRESSEDTEXIMAGE3DPROC) get_proc("glCompressedTexImage3DARB");
	gl3wCompressedTexImage2D = (PFNGLCOMPRESSEDTEXIMAGE2DPROC) get_proc("glCompressedTexImage2D");
	if (!gl3wCompressedTexImage2D) gl3wCompressedTexImage2D = (PFNGLCOMPRESSEDTEXIMAGE2DPROC) get_proc("glCompressedTexImage2DARB");
	gl3wCompressedTexImage1D = (PFNGLCOMPRESSEDTEXIMAGE1DPROC) get_proc("glCompressedTexImage1D");
	if (!gl3wCompressedTexImage1D) gl3wCompressedTexImage1D = (PFNGLCOMPRESSEDTEXIMAGE1DPROC) get_proc("glCompressedTexImage1DARB");
	gl3wCompressedTexSubImage3D = (PFNGLCOMPRESSEDTEXSUBIMAGE3DPROC) get_proc("glCompressedTexSubImage3D");
	if (!gl3wCompressedTexSubImage3D) gl3wCompressedTexSubImage3D = (PFNGLCOMPRESSEDTEXSUBIMAGE3DPROC) get_proc("glCompressedTexSubImage3DARB");
	gl3wCompressedTexSubImage2D = (PFNGLCOMPRESSEDTEXSUBIMAGE2DPROC) get_proc("glCompressedTexSubImage2D");
	if (!gl3wCompressedTexSubImage2D) gl3wCompressedTexSubImage2D = (PFNGLCOMPRESSEDTEXSUBIMAGE2DPROC) get_proc("glCompressedTexSubImage2DARB");
	gl3wCompressedTexSubImage1D = (PFNGLCOMPRESSEDTEXSUBIMAGE1DPROC) get_proc("glCompressedTexSubImage1D");
	if (!gl3wCompressedTexSubImage1D) gl3wCompressedTexSubImage1D = (PFNGLCOMPRESSEDTEXSUBIMAGE1DPROC) get_proc("glCompressedTexSubImage1DARB");
	gl3wGetCompressedTexImage = (PFNGLGETCOMPRESSEDTEXIMAGEPROC) get_proc("glGetCompressedTexImage");
	if (!gl3wGetCompressedTexImage) gl3wGetCompressedTexImage = (PFNGLGETCOMPRESSEDTEXIMAGEPROC) get_proc("glGetCompressedTexImageARB");
	gl3wBlendFuncSeparate = (PFNGLBLENDFUNCSEPARATEPROC) get_proc("glBlendFuncSeparate");
	if (!gl3wBlendFuncSeparate) gl3wBlendFuncSeparate = (PFNGLBLENDFUNCSEPARATEPROC) get_proc("glBlendFuncSeparateEXT");
	gl3wMultiDrawArrays = (PFNGLMULTIDRAWARRAYSPROC) get_proc("glMultiDrawArrays");
	if (!gl3wMultiDrawArrays) gl3wMultiDrawArrays = (PFNGLMULTIDRAWARRAYSPROC) get_proc("glMultiDrawArraysEXT");
	gl3wMultiDrawElements = (PFNGLMULTIDRAWELEMENTSPROC) get_proc("glMultiDrawElements");
	if (!gl3wMultiDrawElements) gl3wMultiDrawElements = (PFNGLMULTIDRAWELEMENTSPROC) get_proc("glMultiDrawElementsEXT");
	gl3wPointParameterf = (PFNGLPOINTPARAMETERFPROC) get_proc("glPointParameterf");
	if (!gl3wPointParameterf) gl3wPointParameterf = (PFNGLPOINTPARAMETERFPROC) get_proc("glPointParameterfARB");
	if (!gl3wPointParameterf) gl3wPointParameterf = (PFNGLPOINTPARAMETERFPROC) get_proc("glPointParameterfEXT");
	gl3wPointParameterfv = (PFNGLPOINTPARAMETERFVPROC) get_proc("glPointParameterfv");
	if (!gl3wPointParameterfv) gl3wPointParameterfv = (PFNGLPOINTPARAMETERFVPROC) get_proc("glPointParameterfvARB");
	if (!gl3wPointParameterfv) gl3wPointParameterfv = (PFNGLPOINTPARAMETERFVPROC) get_proc("glPointParameterfvEXT");
	gl3wPointParameteri = (PFNGLPOINTPARAMETERIPROC) get_proc("glPointParameteri");
	if (!gl3wPointParameteri) gl3wPointParameteri = (PFNGLPOINTPARAMETERIPROC) get_proc("glPointParameteriARB");
	if (!gl3wPointParameteri) gl3wPointParameteri = (PFNGLPOINTPARAMETERIPROC) get_proc("glPointParameteriEXT");
	gl3wPointParameteriv = (PFNGLPOINTPARAMETERIVPROC) get_proc("glPointParameteriv");
	if (!gl3wPointParameteriv) gl3wPointParameteriv = (PFNGLPOINTPARAMETERIVPROC) get_proc("glPointParameterivARB");
	if (!gl3wPointParameteriv) gl3wPointParameteriv = (PFNGLPOINTPARAMETERIVPROC) get_proc("glPointParameterivEXT");
	gl3wGenQueries = (PFNGLGENQUERIESPROC) get_proc("glGenQueries");
	if (!gl3wGenQueries) gl3wGenQueries = (PFNGLGENQUERIESPROC) get_proc("glGenQueriesARB");
	gl3wDeleteQueries = (PFNGLDELETEQUERIESPROC) get_proc("glDeleteQueries");
	if (!gl3wDeleteQueries) gl3wDeleteQueries = (PFNGLDELETEQUERIESPROC) get_proc("glDeleteQueriesARB");
	gl3wIsQuery = (PFNGLISQUERYPROC) get_proc("glIsQuery");
	if (!gl3wIsQuery) gl3wIsQuery = (PFNGLISQUERYPROC) get_proc("glIsQueryARB");
	gl3wBeginQuery = (PFNGLBEGINQUERYPROC) get_proc("glBeginQuery");
	if (!gl3wBeginQuery) gl3wBeginQuery = (PFNGLBEGINQUERYPROC) get_proc("glBeginQueryARB");
	gl3wEndQuery = (PFNGLENDQUERYPROC) get_proc("glEndQuery");
	if (!gl3wEndQuery) gl3wEndQuery = (PFNGLENDQUERYPROC) get_proc("glEndQueryARB");
	gl3wGetQueryiv = (PFNGLGETQUERYIVPROC) get_proc("glGetQueryiv");
	if (!gl3wGetQueryiv) gl3wGetQueryiv = (PFNGLGETQUERYIVPROC) get_proc("glGetQueryivARB");
	gl3wGetQueryObjectiv = (PFNGLGETQUERYOBJECTIVPROC) get_proc("glGetQueryObjectiv");
	if (!gl3wGetQueryObjectiv) gl3wGetQueryObjectiv = (PFNGLGETQUERYOBJECTIVPROC) get_proc("glGetQueryObjectivARB");
	gl3wGetQueryObjectuiv = (PFNGLGETQUERYOBJECTUIVPROC) get_proc("glGetQueryObjectuiv");
	if (!gl3wGetQueryObjectuiv) gl3wGetQueryObjectuiv = (PFNGLGETQUERYOBJECTUIVPROC) get_proc("glGetQueryObjectuivARB");
	gl3wBindBuffer = (PFNGLBINDBUFFERPROC) get_proc("glBindBuffer");
	if (!gl3wBindBuffer) gl3wBindBuffer = (PFNGLBINDBUFFERPROC) get_proc("glBindBufferARB");
	gl3wDeleteBuffers = (PFNGLDELETEBUFFERSPROC) get_proc("glDeleteBuffers");
	if (!gl3wDeleteBuffers) gl3wDeleteBuffers = (PFNGLDELETEBUFFERSPROC) get_proc("glDeleteBuffersARB");
	gl3wGenBuffers = (PFNGLGENBUFFERSPROC) get_proc("glGenBuffers");
	if (!gl3wGenBuffers) gl3wGenBuffers = (PFNGLGENBUFFERSPROC) get_proc("glGenBuffersARB");
	gl3wIsBuffer = (PFNGLISBUFFERPROC) get_proc("glIsBuffer");
	if (!gl3wIsBuffer) gl3wIsBuffer = (PFNGLISBUFFERPROC) get_proc("glIsBufferARB");
	gl3wBufferData = (PFNGLBUFFERDATAPROC) get_proc("glBufferData");
	if (!gl3wBufferData) gl3wBufferData = (PFNGLBUFFERDATAPROC) get_proc("glBufferDataARB");
	gl3wBufferSubData = (PFNGLBUFFERSUBDATAPROC) get_proc("glBufferSubData");
	if (!gl3wBufferSubData) gl3wBufferSubData = (PFNGLBUFFERSUBDATAPROC) get_proc("glBufferSubDataARB");
	gl3wGetBufferSubData = (PFNGLGETBUFFERSUBDATAPROC) get_proc("glGetBufferSubData");
	if (!gl3wGetBufferSubData) gl3wGetBufferSubData = (PFNGLGETBUFFERSUBDATAPROC) get_proc("glGetBufferSubDataARB");
	gl3wMapBuffer = (PFNGLMAPBUFFERPROC) get_proc("glMapBuffer");
	if (!gl3wMapBuffer) gl3wMapBuffer = (PFNGLMAPBUFFERPROC) get_proc("glMapBufferARB");
	gl3wUnmapBuffer = (PFNGLUNMAPBUFFERPROC) get_proc("glUnmapBuffer");
	if (!gl3wUnmapBuffer) gl3wUnmapBuffer = (PFNGLUNMAPBUFFERPROC) get_proc("glUnmapBufferARB");
	gl3wGetBufferParameteriv = (PFNGLGETBUFFERPARAMETERIVPROC) get_proc("glGetBufferParameteriv");
	if (!gl3wGetBufferParameteriv) gl3wGetBufferParameteriv = (PFNGLGETBUFFERPARAMETERIVPROC) get_proc("glGetBufferParameterivARB");
	gl3wGetBufferPointerv = (PFNGLGETBUFFERPOINTERVPROC) get_proc("glGetBufferPointerv");
	if (!gl3wGetBufferPointerv) gl3wGetBufferPointerv = (PFNGLGETBUFFERPOINTERVPROC) get_proc("glGetBufferPointervARB");
	gl3wBlendEquationSeparate = (PFNGLBLENDEQUATIONSEPARATEPROC) get_proc("glBlendEquationSeparate");
	if (!gl3wBlendEquationSeparate) gl3wBlendEquationSeparate = (PFNGLBLENDEQUATIONSEPARATEPROC) get_proc("glBlendEquationSeparateEXT");
	gl3wDrawBuffers = (PFNGLDRAWBUFFERSPROC) get_proc("glDrawBuffers");
	if (!gl3wDrawBuffers) gl3wDrawBuffers = (PFNGLDRAWBUFFERSPROC) get_proc("glDrawBuffersARB");
	...
	if (!gl3wAttachShader) gl3wAttachShader = (PFNGLATTACHSHADERPROC) get_proc("glAttachShaderARB");
	gl3wBindAttribLocation = (PFNGLBINDATTRIBLOCATIONPROC) get_proc("glBindAttribLocation");
	if (!gl3wBindAttribLocation) gl3wBindAttribLocation = (PFNGLBINDATTRIBLOCATIONPROC) get_proc("glBindAttribLocationARB");
	gl3wCompileShader = (PFNGLCOMPILESHADERPROC) get_proc("glCompileShader");
	if (!gl3wCompileShader) gl3wCompileShader = (PFNGLCOMPILESHADERPROC) get_proc("glCompileShaderARB");
	gl3wCreateProgram = (PFNGLCREATEPROGRAMPROC) get_proc("glCreateProgram");
	if (!gl3wCreateProgram) gl3wCreateProgram = (PFNGLCREATEPROGRAMPROC) get_proc("glCreateProgramARB");
	gl3wCreateShader = (PFNGLCREATESHADERPROC) get_proc("glCreateShader");
	if (!gl3wCreateShader) gl3wCreateShader = (PFNGLCREATESHADERPROC) get_proc("glCreateShaderARB");
	gl3wDeleteProgram = (PFNGLDELETEPROGRAMPROC) get_proc("glDeleteProgram");
	if (!gl3wDeleteProgram) gl3wDeleteProgram = (PFNGLDELETEPROGRAMPROC) get_proc("glDeleteProgramARB");
	gl3wDeleteShader = (PFNGLDELETESHADERPROC) get_proc("glDeleteShader");
	if (!gl3wDeleteShader) gl3wDeleteShader = (PFNGLDELETESHADERPROC) get_proc("glDeleteShaderARB");
	gl3wDetachShader = (PFNGLDETACHSHADERPROC) get_proc("glDetachShader");
	if (!gl3wDetachShader) gl3wDetachShader = (PFNGLDETACHSHADERPROC) get_proc("glDetachShaderARB");
	gl3wDisableVertexAttribArray = (PFNGLDISABLEVERTEXATTRIBARRAYPROC) get_proc("glDisableVertexAttribArray");
	if (!gl3wDisableVertexAttribArray) gl3wDisableVertexAttribArray = (PFNGLDISABLEVERTEXATTRIBARRAYPROC) get_proc("glDisableVertexAttribArrayARB");
	gl3wEnableVertexAttribArray = (PFNGLENABLEVERTEXATTRIBARRAYPROC) get_proc("glEnableVertexAttribArray");
	if (!gl3wEnableVertexAttribArray) gl3wEnableVertexAttribArray = (PFNGLENABLEVERTEXATTRIBARRAYPROC) get_proc("glEnableVertexAttribArrayARB");
	gl3wGetActiveAttrib = (PFNGLGETACTIVEATTRIBPROC) get_proc("glGetActiveAttrib");
	if (!gl3wGetActiveAttrib) gl3wGetActiveAttrib = (PFNGLGETACTIVEATTRIBPROC) get_proc("glGetActiveAttribARB");
	gl3wGetActiveUniform = (PFNGLGETACTIVEUNIFORMPROC) get_proc("glGetActiveUniform");
	if (!gl3wGetActiveUniform) gl3wGetActiveUniform = (PFNGLGETACTIVEUNIFORMPROC) get_proc("glGetActiveUniformARB");
	gl3wGetAttachedShaders = (PFNGLGETATTACHEDSHADERSPROC) get_proc("glGetAttachedShaders");
	if (!gl3wGetAttachedShaders) gl3wGetAttachedShaders = (PFNGLGETATTACHEDSHADERSPROC) get_proc("glGetAttachedShadersARB");
	gl3wGetAttribLocation = (PFNGLGETATTRIBLOCATIONPROC) get_proc("glGetAttribLocation");
	if (!gl3wGetAttribLocation) gl3wGetAttribLocation = (PFNGLGETATTRIBLOCATIONPROC) get_proc("glGetAttribLocationARB");
	gl3wGetProgramiv = (PFNGLGETPROGRAMIVPROC) get_proc("glGetProgramiv");
	if (!gl3wGetProgramiv) gl3wGetProgramiv = (PFNGLGETPROGRAMIVPROC) get_proc("glGetProgramivARB");
	gl3wGetProgramInfoLog = (PFNGLGETPROGRAMINFOLOGPROC) get_proc("glGetProgramInfoLog");
	if (!gl3wGetProgramInfoLog) gl3wGetProgramInfoLog = (PFNGLGETPROGRAMINFOLOGPROC) get_proc("glGetProgramInfoLogARB");
	gl3wGetShaderiv = (PFNGLGETSHADERIVPROC) get_proc("glGetShaderiv");
	if (!gl3wGetShaderiv) gl3wGetShaderiv = (PFNGLGETSHADERIVPROC) get_proc("glGetShaderivARB");
	gl3wGetShaderInfoLog = (PFNGLGETSHADERINFOLOGPROC) get_proc("glGetShaderInfoLog");
	if (!gl3wGetShaderInfoLog) gl3wGetShaderInfoLog = (PFNGLGETSHADERINFOLOGPROC) get_proc("glGetShaderInfoLogARB");
	gl3wGetShaderSource = (PFNGLGETSHADERSOURCEPROC) get_proc("glGetShaderSource");
	if (!gl3wGetShaderSource) gl3wGetShaderSource = (PFNGLGETSHADERSOURCEPROC) get_proc("glGetShaderSourceARB");
	gl3wGetUniformLocation = (PFNGLGETUNIFORMLOCATIONPROC) get_proc("glGetUniformLocation");
	if (!gl3wGetUniformLocation) gl3wGetUniformLocation = (PFNGLGETUNIFORMLOCATIONPROC) get_proc("glGetUniformLocationARB");
	...
	if (!gl3wIsProgram) gl3wIsProgram = (PFNGLISPROGRAMPROC) get_proc("glIsProgramARB");
	gl3wIsShader = (PFNGLISSHADERPROC) get_proc("glIsShader");
	if (!gl3wIsShader) gl3wIsShader = (PFNGLISSHADERPROC) get_proc("glIsShaderARB");
	gl3wLinkProgram = (PFNGLLINKPROGRAMPROC) get_proc("glLinkProgram");
	if (!gl3wLinkProgram) gl3wLinkProgram = (PFNGLLINKPROGRAMPROC) get_proc("glLinkProgramARB");
	gl3wShaderSource = (PFNGLSHADERSOURCEPROC) get_proc("glShaderSource");
	if (!gl3wShaderSource) gl3wShaderSource = (PFNGLSHADERSOURCEPROC) get_proc("glShaderSourceARB");
	gl3wUseProgram = (PFNGLUSEPROGRAMPROC) get_proc("glUseProgram");
	if (!gl3wUseProgram) gl3wUseProgram = (PFNGLUSEPROGRAMPROC) get_proc("glUseProgramARB");
	...
	if (!gl3wBeginTransformFeedback) gl3wBeginTransformFeedback = (PFNGLBEGINTRANSFORMFEEDBACKPROC) get_proc("glBeginTransformFeedbackEXT");
	gl3wEndTransformFeedback = (PFNGLENDTRANSFORMFEEDBACKPROC) get_proc("glEndTransformFeedback");
	if (!gl3wEndTransformFeedback) gl3wEndTransformFeedback = (PFNGLENDTRANSFORMFEEDBACKPROC) get_proc("glEndTransformFeedbackEXT");
	gl3wBindBufferRange = (PFNGLBINDBUFFERRANGEPROC) get_proc("glBindBufferRange");
	if (!gl3wBindBufferRange) gl3wBindBufferRange = (PFNGLBINDBUFFERRANGEPROC) get_proc("glBindBufferRangeEXT");
	gl3wBindBufferBase = (PFNGLBINDBUFFERBASEPROC) get_proc("glBindBufferBase");
	if (!gl3wBindBufferBase) gl3wBindBufferBase = (PFNGLBINDBUFFERBASEPROC) get_proc("glBindBufferBaseEXT");
	gl3wTransformFeedbackVaryings = (PFNGLTRANSFORMFEEDBACKVARYINGSPROC) get_proc("glTransformFeedbackVaryings");
	if (!gl3wTransformFeedbackVaryings) gl3wTransformFeedbackVaryings = (PFNGLTRANSFORMFEEDBACKVARYINGSPROC) get_proc("glTransformFeedbackVaryingsEXT");
	gl3wGetTransformFeedbackVarying = (PFNGLGETTRANSFORMFEEDBACKVARYINGPROC) get_proc("glGetTransformFeedbackVarying");
	if (!gl3wGetTransformFeedbackVarying) gl3wGetTransformFeedbackVarying = (PFNGLGETTRANSFORMFEEDBACKVARYINGPROC) get_proc("glGetTransformFeedbackVaryingEXT");
	gl3wClampColor = (PFNGLCLAMPCOLORPROC) get_proc("glClampColor");
	if (!gl3wClampColor) gl3wClampColor = (PFNGLCLAMPCOLORPROC) get_proc("glClampColorARB");
	...
	if (!gl3wDrawArraysInstanced) gl3wDrawArraysInstanced = (PFNGLDRAWARRAYSINSTANCEDPROC) get_proc("glDrawArraysInstancedARB");
	if (!gl3wDrawArraysInstanced) gl3wDrawArraysInstanced = (PFNGLDRAWARRAYSINSTANCEDPROC) get_proc("glDrawArraysInstancedEXT");
	gl3wDrawElementsInstanced = (PFNGLDRAWELEMENTSINSTANCEDPROC) get_proc("glDrawElementsInstanced");
	if (!gl3wDrawElementsInstanced) gl3wDrawElementsInstanced = (PFNGLDRAWELEMENTSINSTANCEDPROC) get_proc("glDrawElementsInstancedARB");
	if (!gl3wDrawElementsInstanced) gl3wDrawElementsInstanced = (PFNGLDRAWELEMENTSINSTANCEDPROC) get_proc("glDrawElementsInstancedEXT");
	gl3wTexBuffer = (PFNGLTEXBUFFERPROC) get_proc("glTexBuffer");
	if (!gl3wTexBuffer) gl3wTexBuffer = (PFNGLTEXBUFFERPROC) get_proc("glTexBufferARB");
	...
	if (!gl3wFramebufferTexture) gl3wFramebufferTexture = (PFNGLFRAMEBUFFERTEXTUREPROC) get_proc("glFramebufferTextureARB");
	if (!gl3wFramebufferTexture) gl3wFramebufferTexture = (PFNGLFRAMEBUFFERTEXTUREPROC) get_proc("glFramebufferTextureEXT");
	gl3wVertexAttribDivisor = (PFNGLVERTEXATTRIBDIVISORPROC) get_proc("glVertexAttribDivisor");
	if (!gl3wVertexAttribDivisor) gl3wVertexAttribDivisor = (PFNGLVERTEXATTRIBDIVISORPROC) get_proc("glVertexAttribDivisorARB");
	...
	if (!gl3wIsRenderbuffer) gl3wIsRenderbuffer = (PFNGLISRENDERBUFFERPROC) get_proc("glIsRenderbufferEXT");
	gl3wBindRenderbuffer = (PFNGLBINDRENDERBUFFERPROC) get_proc("glBindRenderbuffer");
	if (!gl3wBindRenderbuffer) gl3wBindRenderbuffer = (PFNGLBINDRENDERBUFFERPROC) get_proc("glBindRenderbufferEXT");
	gl3wDeleteRenderbuffers = (PFNGLDELETERENDERBUFFERSPROC) get_proc("glDeleteRenderbuffers");
	if (!gl3wDeleteRenderbuffers) gl3wDeleteRenderbuffers = (PFNGLDELETERENDERBUFFERSPROC) get_proc("glDeleteRenderbuffersEXT");
	gl3wGenRenderbuffers = (PFNGLGENRENDERBUFFERSPROC) get_proc("glGenRenderbuffers");
	if (!gl3wGenRenderbuffers) gl3wGenRenderbuffers = (PFNGLGENRENDERBUFFERSPROC) get_proc("glGenRenderbuffersEXT");
	gl3wRenderbufferStorage = (PFNGLRENDERBUFFERSTORAGEPROC) get_proc("glRenderbufferStorage");
	if (!gl3wRenderbufferStorage) gl3wRenderbufferStorage = (PFNGLRENDERBUFFERSTORAGEPROC) get_proc("glRenderbufferStorageEXT");
	gl3wGetRenderbufferParameteriv = (PFNGLGETRENDERBUFFERPARAMETERIVPROC) get_proc("glGetRenderbufferParameteriv");
	if (!gl3wGetRenderbufferParameteriv) gl3wGetRenderbufferParameteriv = (PFNGLGETRENDERBUFFERPARAMETERIVPROC) get_proc("glGetRenderbufferParameterivEXT");
	gl3wIsFramebuffer = (PFNGLISFRAMEBUFFERPROC) get_proc("glIsFramebuffer");
	if (!gl3wIsFramebuffer) gl3wIsFramebuffer = (PFNGLISFRAMEBUFFERPROC) get_proc("glIsFramebufferEXT");
	gl3wBindFramebuffer = (PFNGLBINDFRAMEBUFFERPROC) get_proc("glBindFramebuffer");
	if (!gl3wBindFramebuffer) gl3wBindFramebuffer = (PFNGLBINDFRAMEBUFFERPROC) get_proc("glBindFramebufferEXT");
	gl3wDeleteFramebuffers = (PFNGLDELETEFRAMEBUFFERSPROC) get_proc("glDeleteFramebuffers");
	if (!gl3wDeleteFramebuffers) gl3wDeleteFramebuffers = (PFNGLDELETEFRAMEBUFFERSPROC) get_proc("glDeleteFramebuffersEXT");
	gl3wGenFramebuffers = (PFNGLGENFRAMEBUFFERSPROC) get_proc("glGenFramebuffers");
	if (!gl3wGenFramebuffers) gl3wGenFramebuffers = (PFNGLGENFRAMEBUFFERSPROC) get_proc("glGenFramebuffersEXT");
	gl3wCheckFramebufferStatus = (PFNGLCHECKFRAMEBUFFERSTATUSPROC) get_proc("glCheckFramebufferStatus");
	if (!gl3wCheckFramebufferStatus) gl3wCheckFramebufferStatus = (PFNGLCHECKFRAMEBUFFERSTATUSPROC) get_proc("glCheckFramebufferStatusEXT");
	gl3wFramebufferTexture1D = (PFNGLFRAMEBUFFERTEXTURE1DPROC) get_proc("glFramebufferTexture1D");
	if (!gl3wFramebufferTexture1D) gl3wFramebufferTexture1D = (PFNGLFRAMEBUFFERTEXTURE1DPROC) get_proc("glFramebufferTexture1DEXT");
	gl3wFramebufferTexture2D = (PFNGLFRAMEBUFFERTEXTURE2DPROC) get_proc("glFramebufferTexture2D");
	if (!gl3wFramebufferTexture2D) gl3wFramebufferTexture2D = (PFNGLFRAMEBUFFERTEXTURE2DPROC) get_proc("glFramebufferTexture2DEXT");
	gl3wFramebufferTexture3D = (PFNGLFRAMEBUFFERTEXTURE3DPROC) get_proc("glFramebufferTexture3D");
	if (!gl3wFramebufferTexture3D) gl3wFramebufferTexture3D = (PFNGLFRAMEBUFFERTEXTURE3DPROC) get_proc("glFramebufferTexture3DEXT");
	gl3wFramebufferRenderbuffer = (PFNGLFRAMEBUFFERRENDERBUFFERPROC) get_proc("glFramebufferRenderbuffer");
	if (!gl3wFramebufferRenderbuffer) gl3wFramebufferRenderbuffer = (PFNGLFRAMEBUFFERRENDERBUFFERPROC) get_proc("glFramebufferRenderbufferEXT");
	...
	if (!gl3wGetFramebufferAttachmentParameteriv) gl3wGetFramebufferAttachmentParameteriv = (PFNGLGETFRAMEBUFFERATTACHMENTPARAMETERIVPROC) get_proc("glGetFramebufferAttachmentParameterivEXT");
	gl3wGenerateMipmap = (PFNGLGENERATEMIPMAPPROC) get_proc("glGenerateMipmap");
	if (!gl3wGenerateMipmap) gl3wGenerateMipmap = (PFNGLGENERATEMIPMAPPROC) get_proc("glGenerateMipmapEXT");
	gl3wBlitFramebuffer = (PFNGLBLITFRAMEBUFFERPROC) get_proc("glBlitFramebuffer");
	if (!gl3wBlitFramebuffer) gl3wBlitFramebuffer = (PFNGLBLITFRAMEBUFFERPROC) get_proc("glBlitFramebufferEXT");
	gl3wRenderbufferStorageMultisample = (PFNGLRENDERBUFFERSTORAGEMULTISAMPLEPROC) get_proc("glRenderbufferStorageMultisample");
	if (!gl3wRenderbufferStorageMultisample) gl3wRenderbufferStorageMultisample = (PFNGLRENDERBUFFERSTORAGEMULTISAMPLEPROC) get_proc("glRenderbufferStorageMultisampleEXT");
	gl3wFramebufferTextureLayer = (PFNGLFRAMEBUFFERTEXTURELAYERPROC) get_proc("glFramebufferTextureLayer");
	if (!gl3wFramebufferTextureLayer) gl3wFramebufferTextureLayer = (PFNGLFRAMEBUFFERTEXTURELAYERPROC) get_proc("glFramebufferTextureLayerEXT");
	...
	if (!gl3wProvokingVertex) gl3wProvokingVertex = (PFNGLPROVOKINGVERTEXPROC) get_proc("glProvokingVertexEXT");
