	...
	std::unique_ptr<Effect>										EffectContext::Compile(const boost::filesystem::path &path, const std::vector<std::pair<std::string, std::string>> &defines, std::string &errors)
	{
		...
		if (status)
		{
			...
			static const char *intrinsics =
				...
				"float4   tex1D(sampler1D, float, int);"
				"float4   tex1Dlod(sampler1D, float4);"
				"float4   tex1Dlod(sampler1D, float4, int);"
				"float4   tex1Dfetch(sampler1D, int4);"
				"float4   tex1Dfetch(sampler1D, int4, int);"
				"float4   tex1Dbias(sampler1D, float4);"
				"float4   tex1Dbias(sampler1D, float4, int);"
				"int3     tex1Dsize(sampler1D, int);"
				"float4   tex2D(sampler2D, float2);"
				"float4   tex2D(sampler2D, float2, int);"
				"float4   tex2Dlod(sampler2D, float4);"
				"float4   tex2Dlod(sampler2D, float4, int);"
				"float4   tex2Dfetch(sampler2D, int4);"
				"float4   tex2Dfetch(sampler2D, int4, int);"
				"float4   tex2Dbias(sampler2D, float4);"
				"float4   tex2Dbias(sampler2D, float4, int);"
				"int3     tex2Dsize(sampler2D, int);"
				"float4   tex3D(sampler3D, float3);"
				"float4   tex3D(sampler3D, float3, int);"
				"float4   tex3Dlod(sampler3D, float4);"
				"float4   tex3Dlod(sampler3D, float4, int);"
				"float4   tex3Dfetch(sampler3D, int4);"
				"float4   tex3Dfetch(sampler3D, int4, int);"
				"float4   tex3Dbias(sampler3D, float4);"
				"float4   tex3Dbias(sampler3D, float4, int);"
				...
				"uint     asint(int);"
				"uint2    asint(int2);"
				"uint2x2  asint(int2x2);"
				"uint2x3  asint(int2x3);"
				"uint2x4  asint(int2x4);"
				"uint3    asint(int3);"
				"uint3x2  asint(int3x2);"
				"uint3x3  asint(int3x3);"
				"uint3x4  asint(int3x4);"
				"uint4    asint(int4);"
				"uint4x2  asint(int4x2);"
				"uint4x3  asint(int4x3);"
				"uint4x4  asint(int4x4);"
				"uint     asint(float);"
				"uint2    asint(float2);"
				"uint2x2  asint(float2x2);"
				"uint2x3  asint(float2x3);"
				"uint2x4  asint(float2x4);"
				"uint3    asint(float3);"
				"uint3x2  asint(float3x2);"
				"uint3x3  asint(float3x3);"
				"uint3x4  asint(float3x4);"
				"uint4    asint(float4);"
				"uint4x2  asint(float4x2);"
				"uint4x3  asint(float4x3);"
				"uint4x4  asint(float4x4);"
				""
				"float    asfloat(float);"
