		...
		namespace
		{
			...
			public:
				...
				void VisitShader(const FX::Nodes::Function *node, const std::string &shadertype, D3D10Technique::Pass &pass)
				{
					...
					HRESULT hr = D3DCompile(source.c_str(), source.length(), nullptr, nullptr, nullptr, node->Name.c_str(), (shadertype + "_4_0").c_str(), D3DCOMPILE_ENABLE_STRICTNESS, 0, &compiled, &errors);
