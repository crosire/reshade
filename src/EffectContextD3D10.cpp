...
namespace ReShade
{
	namespace
	{
		...
		Effect::Texture *										D3D10Effect::GetTexture(const std::string &name)
		{
		...
		Effect::Constant *										D3D10Effect::GetConstant(const std::string &name)
		{
		...
		Effect::Technique *										D3D10Effect::GetTechnique(const std::string &name)
		{
