...
namespace reshade
{
	...
	d3d9_fx_compiler::d3d9_fx_compiler(d3d9_runtime *runtime, const fx::nodetree &ast, std::string &errors, bool skipoptimization) : compiler(ast, errors), _runtime(runtime), _skip_shader_optimization(skipoptimization), _current_register_offset(0), _current_function(nullptr)
	{
	}
