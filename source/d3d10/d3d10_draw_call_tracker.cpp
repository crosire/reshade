...
{
	void d3d10_draw_call_tracker::merge(const d3d10_draw_call_tracker& source)
	{
	...
	void d3d10_draw_call_tracker::reset()
	{
	...
	void d3d10_draw_call_tracker::on_map(ID3D10Resource *resource)
	{
	...
	void d3d10_draw_call_tracker::on_draw(ID3D10Device *device, UINT vertices)
	{
	...
	bool d3d10_draw_call_tracker::check_depth_texture_format(int depth_buffer_texture_format, ID3D10DepthStencilView *pDepthStencilView)
	{
	...
	bool d3d10_draw_call_tracker::check_depthstencil(ID3D10DepthStencilView *depthstencil) const
	{
		return _counters_per_used_depthstencil.find(depthstencil) != _counters_per_used_depthstencil.end();
	}

	void d3d10_draw_call_tracker::track_rendertargets(int depth_buffer_texture_format, ID3D10DepthStencilView *depthstencil, UINT num_views, ID3D10RenderTargetView *const *views)
	{
	...
	void d3d10_draw_call_tracker::track_depth_texture(int depth_buffer_texture_format, UINT index, com_ptr<ID3D10Texture2D> src_texture, com_ptr<ID3D10DepthStencilView> src_depthstencil, com_ptr<ID3D10Texture2D> dest_texture, bool cleared)
	{
	...
	d3d10_draw_call_tracker::intermediate_snapshot_info d3d10_draw_call_tracker::find_best_snapshot(UINT width, UINT height)
	{
	...
	void d3d10_draw_call_tracker::keep_cleared_depth_textures()
	{
	...
	ID3D10Texture2D *d3d10_draw_call_tracker::find_best_cleared_depth_buffer_texture(UINT depth_buffer_clearing_number)
	{
