...
namespace reshade::d3d10
{
	...
	public:
		...
		bool create_shader_module(api::shader_stage type, api::shader_format format, const void *data, size_t size, const char *entry_point, api::shader_module *out) final;
		...
		void add_debug_marker(const char *, const float[4]) final { /* no-op */ }
		void begin_debug_marker(const char *, const float[4]) final { /* no-op */ }
		void finish_debug_marker() final { /* no-op */ }
