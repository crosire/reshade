...
namespace reshade::d3d10
{
	...
	private:
		...
		bool add_sampler(const reshadefx::sampler_info &info, d3d10_technique_data &effect);
		bool add_technique(const reshadefx::technique_info &info, const d3d10_technique_data &effect);
