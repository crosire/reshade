...
bool reshade::d3d10::runtime_d3d10::init_technique(technique &technique, d3d10_technique_data &&impl_init, const std::unordered_map<std::string, com_ptr<IUnknown>> &entry_points)
{
