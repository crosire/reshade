...
namespace reshade
{
	...
	gl_fx_compiler::gl_fx_compiler(gl_runtime *runtime, const fx::nodetree &ast, std::string &errors) : compiler(ast, errors), _runtime(runtime), _current_function(nullptr), _current_uniform_size(0)
	{
	}
