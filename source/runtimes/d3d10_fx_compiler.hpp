...
namespace reshade
{
	...
	{
	public:
		d3d10_fx_compiler(d3d10_runtime *runtime, const fx::nodetree &ast, std::string &errors, bool skipoptimization = false);
	...
	private:
		...
		void visit(std::stringstream &output, const fx::nodes::declarator_list_node *node, bool single_statement) override;
