...
namespace reshadefx
{
	...
	namespace
	{
		...
		const intrinsic s_intrinsics[] = {
			...
			intrinsic("tex2D", intrinsic_expression_node::texture, type_node::datatype_float, 4, 1, type_node::datatype_sampler, 0, 0, type_node::datatype_float, 2, 1),
			intrinsic("tex2Dfetch", intrinsic_expression_node::texture_fetch, type_node::datatype_float, 4, 1, type_node::datatype_sampler, 0, 0, type_node::datatype_int, 4, 1),
			intrinsic("tex2Dgather", intrinsic_expression_node::texture_gather, type_node::datatype_float, 4, 1, type_node::datatype_sampler, 0, 0, type_node::datatype_float, 2, 1, type_node::datatype_int, 1, 1),
			intrinsic("tex2Dgatheroffset", intrinsic_expression_node::texture_gather_offset, type_node::datatype_float, 4, 1, type_node::datatype_sampler, 0, 0, type_node::datatype_float, 2, 1, type_node::datatype_int, 2, 1, type_node::datatype_int, 1, 1),
			intrinsic("tex2Dgrad", intrinsic_expression_node::texture_gradient, type_node::datatype_float, 4, 1, type_node::datatype_sampler, 0, 0, type_node::datatype_float, 2, 1, type_node::datatype_float, 2, 1, type_node::datatype_float, 2, 1),
			intrinsic("tex2Dlod", intrinsic_expression_node::texture_level, type_node::datatype_float, 4, 1, type_node::datatype_sampler, 0, 0, type_node::datatype_float, 4, 1),
			intrinsic("tex2Dlodoffset", intrinsic_expression_node::texture_level_offset, type_node::datatype_float, 4, 1, type_node::datatype_sampler, 0, 0, type_node::datatype_float, 4, 1, type_node::datatype_int, 2, 1),
			intrinsic("tex2Doffset", intrinsic_expression_node::texture_offset, type_node::datatype_float, 4, 1, type_node::datatype_sampler, 0, 0, type_node::datatype_float, 2, 1, type_node::datatype_int,  2, 1),
			intrinsic("tex2Dproj", intrinsic_expression_node::texture_projection, type_node::datatype_float, 4, 1, type_node::datatype_sampler, 0, 0, type_node::datatype_float, 4, 1),
			intrinsic("tex2Dsize", intrinsic_expression_node::texture_size, type_node::datatype_int, 2, 1, type_node::datatype_sampler, 0, 0, type_node::datatype_int, 1, 1),
