...
namespace reshade::d3d11
{
	...
	bool d3d11_draw_call_tracker::check_depth_texture_format(int depth_buffer_texture_format, ID3D11DepthStencilView *pDepthStencilView)
	{
	...
	void d3d11_draw_call_tracker::track_rendertargets(int depth_buffer_texture_format, ID3D11DepthStencilView *depthstencil, UINT num_views, ID3D11RenderTargetView *const *views)
	{
	...
	void d3d11_draw_call_tracker::track_depth_texture(int depth_buffer_texture_format, UINT index, com_ptr<ID3D11Texture2D> src_texture, com_ptr<ID3D11DepthStencilView> src_depthstencil, com_ptr<ID3D11Texture2D> dest_texture, bool cleared)
	{
