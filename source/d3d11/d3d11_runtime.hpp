...
namespace reshade::d3d11
{
	...
	public:
		...
		void on_present(depth_counter_tracker& tracker, std::unordered_map<ID3D11DepthStencilView*, depthstencil_size> const& depthstencils);
	...
	private:
		...
		void detect_depth_source(depth_counter_tracker& tracker, std::unordered_map<ID3D11DepthStencilView*, depthstencil_size> const& depthstencils);
