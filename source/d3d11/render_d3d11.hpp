...
namespace reshade::d3d11
{
	...
	public:
		...
		bool create_resource(const api::resource_desc &desc, api::resource_usage initial_state, const api::mapped_subresource *initial_data, api::resource_handle *out_resource) final;
