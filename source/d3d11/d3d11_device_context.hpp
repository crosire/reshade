...
#if RESHADE_ADDON
	void invoke_map_resource_event(ID3D11Resource *resource, UINT subresource, D3D11_MAP map_type, reshade::api::subresource_data *data);
	void invoke_unmap_resource_event(ID3D11Resource *resource, UINT subresource);
