...
void reshade::d3d11::runtime_d3d11::update_texture(texture &texture, const uint8_t *pixels)
{
...
bool reshade::d3d11::runtime_d3d11::init_technique(technique &technique, d3d11_technique_data &&impl_init, const std::unordered_map<std::string, com_ptr<IUnknown>> &entry_points)
{
