...
namespace reshade::d3d11
{
	...
	bool runtime_d3d11::init_technique(technique &obj, const d3d11_technique_data &effect, const std::unordered_map<std::string, com_ptr<ID3D11VertexShader>> &vs_entry_points, const std::unordered_map<std::string, com_ptr<ID3D11PixelShader>> &ps_entry_points)
	{
