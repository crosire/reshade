...
namespace reshade
{
	...
	{
	public:
		d3d11_fx_compiler(d3d11_runtime *runtime, const reshadefx::syntax_tree &ast, std::string &errors, bool skipoptimization = false);
	...
	private:
		...
		void visit_pass(const reshadefx::nodes::pass_declaration_node *node, d3d11_pass &pass);
