...
namespace reshade::d3d11
{
	...
	public:
		...
		ID3D11DepthStencilView* get_best_depth_stencil(UINT drawcalls, const com_ptr<ID3D11Device> device, const com_ptr<ID3D11DeviceContext> devicecontext, UINT width, UINT height, UINT depth_buffer_texture_format);
