...
bool reshade::d3d11::device_impl::create_sampler(const api::sampler_desc &desc, api::sampler *out_sampler)
{
...
void reshade::d3d11::device_impl::destroy_sampler(api::sampler sampler)
{
	if (sampler != 0)
...
bool reshade::d3d11::device_impl::create_resource(const api::resource_desc &desc, const api::subresource_data *initial_data, api::resource_usage, api::resource *out_resource, HANDLE *shared_handle)
{
	*out_resource = { 0 };
	...
	case api::resource_type::texture_2d:
		if (com_ptr<ID3D11Device3> device3;
			FAILED(_orig->QueryInterface(&device3)))
		{
...
void reshade::d3d11::device_impl::destroy_resource(api::resource resource)
{
	if (resource != 0)
...
bool reshade::d3d11::device_impl::create_resource_view(api::resource resource, api::resource_usage usage_type, const api::resource_view_desc &desc, api::resource_view *out_view)
{
	*out_view = { 0 };
...
void reshade::d3d11::device_impl::destroy_resource_view(api::resource_view view)
{
	if (view != 0)
...
bool reshade::d3d11::device_impl::create_vertex_shader(const api::shader_desc &desc, api::pipeline *out_pipeline)
{
...
bool reshade::d3d11::device_impl::create_hull_shader(const api::shader_desc &desc, api::pipeline *out_pipeline)
{
...
bool reshade::d3d11::device_impl::create_domain_shader(const api::shader_desc &desc, api::pipeline *out_pipeline)
{
...
bool reshade::d3d11::device_impl::create_geometry_shader(const api::shader_desc &desc, api::pipeline *out_pipeline)
{
...
bool reshade::d3d11::device_impl::create_pixel_shader(const api::shader_desc &desc, api::pipeline *out_pipeline)
{
...
bool reshade::d3d11::device_impl::create_compute_shader(const api::shader_desc &desc, api::pipeline *out_pipeline)
{
...
bool reshade::d3d11::device_impl::create_blend_state(const api::blend_desc &desc, api::pipeline *out_pipeline)
{
...
bool reshade::d3d11::device_impl::create_rasterizer_state(const api::rasterizer_desc &desc, api::pipeline *out_pipeline)
{
...
bool reshade::d3d11::device_impl::create_depth_stencil_state(const api::depth_stencil_desc &desc, api::pipeline *out_pipeline)
{
...
bool reshade::d3d11::device_impl::create_pipeline(api::pipeline_layout, uint32_t subobject_count, const api::pipeline_subobject *subobjects, api::pipeline *out_pipeline)
{
	...
	if (subobject_count == 1 || (subobject_count == 2 && subobjects[1].type == api::pipeline_subobject_type::dynamic_pipeline_states))
	{
		if (subobjects->count != 0)
		{
			...
			case api::pipeline_subobject_type::hull_shader:
				assert(subobjects->count == 1);
				return create_hull_shader(*static_cast<const api::shader_desc *>(subobjects->data), out_pipeline);
			case api::pipeline_subobject_type::domain_shader:
				assert(subobjects->count == 1);
				return create_domain_shader(*static_cast<const api::shader_desc *>(subobjects->data), out_pipeline);
			...
			case api::pipeline_subobject_type::compute_shader:
				assert(subobjects->count == 1);
				return create_compute_shader(*static_cast<const api::shader_desc *>(subobjects->data), out_pipeline);
...
void reshade::d3d11::device_impl::destroy_pipeline(api::pipeline pipeline)
{
...
bool reshade::d3d11::device_impl::create_pipeline_layout(uint32_t param_count, const api::pipeline_layout_param *params, api::pipeline_layout *out_layout)
{
	*out_layout = { 0 };
...
void reshade::d3d11::device_impl::destroy_pipeline_layout(api::pipeline_layout layout)
{
...
void reshade::d3d11::device_impl::destroy_query_heap(api::query_heap heap)
{
...
void reshade::d3d11::device_impl::destroy_fence(api::fence fence)
{
...
void reshade::d3d11::device_impl::get_acceleration_structure_size(api::acceleration_structure_type, api::acceleration_structure_build_flags, uint32_t, const api::acceleration_structure_build_input *, uint64_t *out_size, uint64_t *out_build_scratch_size, uint64_t *out_update_scratch_size) const
{
	if (out_size != nullptr)
		*out_size = 0;
