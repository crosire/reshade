...
const imgui_function_table_19040 init_imgui_function_table_19040() { return {
	...
	g_imgui_function_table_19180.GetWindowDrawList,
	...
	[]() -> imgui_draw_list_19040 * { return g_imgui_function_table_19180.GetBackgroundDrawList(nullptr); },
	[]() -> imgui_draw_list_19040 * { return g_imgui_function_table_19180.GetForegroundDrawList(nullptr); },
	g_imgui_function_table_19180.GetBackgroundDrawList,
	g_imgui_function_table_19180.GetForegroundDrawList,
	...
	g_imgui_function_table_19180.ImDrawList_PushClipRect,
	g_imgui_function_table_19180.ImDrawList_PushClipRectFullScreen,
	g_imgui_function_table_19180.ImDrawList_PopClipRect,
	g_imgui_function_table_19180.ImDrawList_PushTextureID,
	g_imgui_function_table_19180.ImDrawList_PopTextureID,
	g_imgui_function_table_19180.ImDrawList_AddLine,
	g_imgui_function_table_19180.ImDrawList_AddRect,
	g_imgui_function_table_19180.ImDrawList_AddRectFilled,
	g_imgui_function_table_19180.ImDrawList_AddRectFilledMultiColor,
	g_imgui_function_table_19180.ImDrawList_AddQuad,
	g_imgui_function_table_19180.ImDrawList_AddQuadFilled,
	g_imgui_function_table_19180.ImDrawList_AddTriangle,
	g_imgui_function_table_19180.ImDrawList_AddTriangleFilled,
	g_imgui_function_table_19180.ImDrawList_AddCircle,
	g_imgui_function_table_19180.ImDrawList_AddCircleFilled,
	g_imgui_function_table_19180.ImDrawList_AddNgon,
	g_imgui_function_table_19180.ImDrawList_AddNgonFilled,
	[](imgui_draw_list_19040 *_this, const ImVec2 &center, float radius_x, float radius_y, ImU32 col, float rot, int num_segments, float thickness) -> void { g_imgui_function_table_19180.ImDrawList_AddEllipse(_this, center, ImVec2(radius_x, radius_y), col, rot, num_segments, thickness); },
	[](imgui_draw_list_19040 *_this, const ImVec2 &center, float radius_x, float radius_y, ImU32 col, float rot, int num_segments) -> void { g_imgui_function_table_19180.ImDrawList_AddEllipseFilled(_this, center, ImVec2(radius_x, radius_y), col, rot, num_segments); },
	g_imgui_function_table_19180.ImDrawList_AddText,
	[](imgui_draw_list_19040 *_this, const imgui_font_19040 *font, float font_size, const ImVec2 &pos, ImU32 col, const char *text_begin, const char *text_end, float wrap_width, const ImVec4 *cpu_fine_clip_rect) -> void {
		if (font != nullptr) {
			...
			convert(*font, temp);
			g_imgui_function_table_19180.ImDrawList_AddText2(_this, &temp, font_size, pos, col, text_begin, text_end, wrap_width, cpu_fine_clip_rect);
		}
		else {
			g_imgui_function_table_19180.ImDrawList_AddText2(_this, nullptr, font_size, pos, col, text_begin, text_end, wrap_width, cpu_fine_clip_rect);
		}
	},
	g_imgui_function_table_19180.ImDrawList_AddPolyline,
	g_imgui_function_table_19180.ImDrawList_AddConvexPolyFilled,
	g_imgui_function_table_19180.ImDrawList_AddBezierCubic,
	g_imgui_function_table_19180.ImDrawList_AddBezierQuadratic,
	g_imgui_function_table_19180.ImDrawList_AddImage,
	g_imgui_function_table_19180.ImDrawList_AddImageQuad,
	g_imgui_function_table_19180.ImDrawList_AddImageRounded,
	g_imgui_function_table_19180.ImDrawList_PathArcTo,
	g_imgui_function_table_19180.ImDrawList_PathArcToFast,
	[](imgui_draw_list_19040 *_this, const ImVec2 &center, float radius_x, float radius_y, float rot, float a_min, float a_max, int num_segments) -> void { g_imgui_function_table_19180.ImDrawList_PathEllipticalArcTo(_this, center, ImVec2(radius_x, radius_y), rot, a_min, a_max, num_segments); },
	g_imgui_function_table_19180.ImDrawList_PathBezierCubicCurveTo,
	g_imgui_function_table_19180.ImDrawList_PathBezierQuadraticCurveTo,
	g_imgui_function_table_19180.ImDrawList_PathRect,
	[](imgui_draw_list_19040 *_this, ImDrawCallback callback, void *callback_data) -> void { g_imgui_function_table_19180.ImDrawList_AddCallback(_this, callback, callback_data, 0); },
	g_imgui_function_table_19180.ImDrawList_AddDrawCmd,
	g_imgui_function_table_19180.ImDrawList_CloneOutput,
	g_imgui_function_table_19180.ImDrawList_PrimReserve,
	g_imgui_function_table_19180.ImDrawList_PrimUnreserve,
	g_imgui_function_table_19180.ImDrawList_PrimRect,
	g_imgui_function_table_19180.ImDrawList_PrimRectUV,
	g_imgui_function_table_19180.ImDrawList_PrimQuadUV,
	...
	[](const imgui_font_19040 *_this, imgui_draw_list_19040 *draw_list, float size, const ImVec2 &pos, ImU32 col, ImWchar c) -> void {
		imgui_font_19180 temp;
		convert(*_this, temp);
		return g_imgui_function_table_19180.ImFont_RenderChar(&temp, draw_list, size, pos, col, c);
	},
	[](const imgui_font_19040 *_this, imgui_draw_list_19040 *draw_list, float size, const ImVec2 &pos, ImU32 col, const ImVec4 &clip_rect, const char *text_begin, const char *text_end, float wrap_width, bool cpu_fine_clip) -> void {
		imgui_font_19180 temp;
		convert(*_this, temp);
		return g_imgui_function_table_19180.ImFont_RenderText(&temp, draw_list, size, pos, col, clip_rect, text_begin, text_end, wrap_width, cpu_fine_clip);
	},
