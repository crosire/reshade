...
locked_ptr_hash_map<reshade::vulkan::command_list_impl *> g_vulkan_command_buffers;
...
void     VKAPI_CALL vkCmdExecuteCommands(VkCommandBuffer commandBuffer, uint32_t commandBufferCount, const VkCommandBuffer *pCommandBuffers)
{
	...
	{
		reshade::vulkan::command_list_impl *const secondary_cmd_impl = g_vulkan_command_buffers.at((uint64_t)pCommandBuffers[i]);
