	...
	namespace fx
	{
		...
		namespace
		{
			...
			const intrinsic s_intrinsics[] =
			{
				...
				intrinsic("all", intrinsic_expression_node::all, type_node::datatype_bool, 2, 1, type_node::datatype_bool, 2, 1),
				intrinsic("all", intrinsic_expression_node::all, type_node::datatype_bool, 3, 1, type_node::datatype_bool, 3, 1),
				intrinsic("all", intrinsic_expression_node::all, type_node::datatype_bool, 4, 1, type_node::datatype_bool, 4, 1),
				intrinsic("any", intrinsic_expression_node::any, type_node::datatype_bool, 1, 1, type_node::datatype_bool, 1, 1),
				intrinsic("any", intrinsic_expression_node::any, type_node::datatype_bool, 2, 1, type_node::datatype_bool, 2, 1),
				intrinsic("any", intrinsic_expression_node::any, type_node::datatype_bool, 3, 1, type_node::datatype_bool, 3, 1),
				intrinsic("any", intrinsic_expression_node::any, type_node::datatype_bool, 4, 1, type_node::datatype_bool, 4, 1),
				...
				intrinsic("rcp", intrinsic_expression_node::sign, type_node::datatype_float, 1, 1, type_node::datatype_float, 1, 1),
				intrinsic("rcp", intrinsic_expression_node::sign, type_node::datatype_float, 2, 1, type_node::datatype_float, 2, 1),
				intrinsic("rcp", intrinsic_expression_node::sign, type_node::datatype_float, 3, 1, type_node::datatype_float, 3, 1),
				intrinsic("rcp", intrinsic_expression_node::sign, type_node::datatype_float, 4, 1, type_node::datatype_float, 4, 1),
