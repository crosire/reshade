...
namespace reshade
{
	enum class addon_event
	{
		...
		/// <para>Callback function signature: <c>void (api::device *device, uint32_t max_descriptors, api::descriptor_pool pool)</c></para>
		/// </summary>
		...
		/// <summary>
		/// Called after 'ID3D12GraphicsCommandList::BeginRenderPass', 'glBindFramebuffer' or 'vkCmdBeginRenderPass'.
		/// <para>Callback function signature: <c>void (api::command_list *cmd_list, api::render_pass pass, api::framebuffer fbo)</c></para>
		/// </summary>
		begin_render_pass,
		/// <summary>
		/// Called after 'ID3D12GraphicsCommandList::EndRenderPass', 'vkCmdEndRenderPass'.
		/// <para>Callback function signature: <c>void (api::command_list *cmd_list)</c></para>
		/// </summary>
		finish_render_pass,
		/// <summary>
...
#define RESHADE_DEFINE_ADDON_EVENT_TRAITS(ev, ret, ...) \
	...
	RESHADE_DEFINE_ADDON_EVENT_TRAITS(addon_event::init_descriptor_pool, void, api::device *device, uint32_t max_descriptors, api::descriptor_pool pool);
