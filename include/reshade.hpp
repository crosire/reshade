...
RESHADE_API_LIBRARY_DECL void ReShadeRegisterOverlay2(int id, const char *title, void(*callback)(reshade::api::effect_runtime *runtime));
RESHADE_API_LIBRARY_DECL void ReShadeUnregisterOverlay(const char *title, void(*callback)(reshade::api::effect_runtime *runtime));
RESHADE_API_LIBRARY_DECL void ReShadeUnregisterOverlay2(int id, const char *title, void(*callback)(reshade::api::effect_runtime *runtime));
...
namespace reshade
{
	...
	/// <param name="title">Null-terminated title string, or <see langword="nullptr"/> to register a settings overlay for this add-on.</param>
	/// <param name="callback">Pointer to the callback function.</param>
	inline void register_overlay(int id, const char *title, void(*callback)(api::effect_runtime *runtime))
	{
#if defined(RESHADE_API_LIBRARY)
		ReShadeRegisterOverlay2(id, title, callback);
#else
		static const auto func = reinterpret_cast<void(*)(int, const char *, void(*)(api::effect_runtime *))>(
			GetProcAddress(internal::get_reshade_module_handle(), "ReShadeRegisterOverlay2"));
		if (func != nullptr)
			func(id, title, callback);
#endif
	}
	/// <summary>
	...
	/// <param name="title">Null-terminated title string.</param>
	/// <param name="callback">Pointer to the callback function.</param>
	inline void unregister_overlay(int id, const char *title, void(*callback)(api::effect_runtime *runtime))
	{
#if defined(RESHADE_API_LIBRARY)
		ReShadeUnregisterOverlay2(id, title, callback);
#else
		static const auto func = reinterpret_cast<void(*)(int, const char *, void(*)(api::effect_runtime *))>(
			GetProcAddress(internal::get_reshade_module_handle(), "ReShadeUnregisterOverlay2"));
		if (func != nullptr)
			func(id, title, callback);
#endif
	}
